...
SYS_PROMPT_TEMPLATE = (
    ...
    '- 섹션끼리 내용이 겹치면 안 된다. 같은 주제를 수식어만 바꿔'
    '(예: "~ 개요"와 "~ 핵심", "주요 ~"와 "대표 ~"처럼) 둘 이상의 섹션으로 나누지 마라. '
    '의미가 같거나 동의어인 섹션을 만들지 말고, 같은 성격의 내용은 하나의 섹션으로 합쳐라.\n'
    '- 자료가 짧거나 주제가 적으면 섹션 수를 과감히 줄여라(2~4개). '
    '비슷한 섹션을 여러 개 만드는 것보다, 적고 뚜렷하게 구분되는 섹션이 낫다.'
)
