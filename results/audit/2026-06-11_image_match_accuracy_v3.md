# image-caption matching accuracy (2026-06-11, v3)
...
| 6 | 왜관도 | 7 | `input/img_국사/fig_7_3.png` | - | 미배치 | 0.353 | cos=0.355 hub-0.002 |
...
| 22 | 통신사 행렬도 | 27 | `input/img_국사/fig_27_3.png` | 통신사 | 1차 | 0.961 | name+0.50 cos=0.470 hub-0.010 |
...
| 25 | 이완이 썼던 투구 | 31 | `input/img_국사/fig_31_2.png` | - | 미배치 (충돌) | 0.768 | name+0.50 cos=0.270 hub-0.002 |
| 26 | 이완에게 내린 홍패 교지 | 31 | `input/img_국사/fig_31_3.png` | 이완 | 1차 | 0.807 | name+0.50 cos=0.309 hub-0.002 |
| 27 | 나선 정벌 | 31 | `input/img_국사/fig_31_4.png` | 나선 정벌 | 1차 | 0.901 | name+0.50 cos=0.403 hub-0.002 |
| 28 | 대장간 | 36 | `input/img_국사/fig_36_2.png` | - | 미배치 | 0.490 | cos=0.492 hub-0.002 |
| 29 | 영조 어진 | 37 | `input/img_국사/fig_37_3.png` | 영조 | 1차 | 1.056 | name+0.50 cos=0.586 hub-0.029 |
| 30 | 거중기 모형 | 37 | `input/img_국사/fig_37_4.png` | - | 미배치 | 0.395 | cos=0.398 hub-0.002 |
| 31 | 옥산 서원 | 38 | `input/img_국사/fig_38_2.png` | - | 미배치 (충돌) | 0.727 | name+0.50 cos=0.234 hub-0.007 |
| 32 | 송시열 초상 | 39 | `input/img_국사/fig_39_2.png` | 송시열 | 1차 | 0.969 | name+0.50 cos=0.471 hub-0.002 |
...
## diff vs 2026-06-11_image_match_accuracy_v2.md

- 바뀐 행: 1 / 34

| # | 제목 | before (노드, tier, 점수) | after (노드, tier, 점수) |
|---:|---|---|---|
| 6 | 왜관도 | 중앙군 · 캐스케이드 · 0.667 | - · 미배치 · 0.353 |