...
계단 2. `probe.py` 실제 실행: PASS. `results\exp06_room_probe\report.md` 갱신 출력 확인. 30초 미만, LLM 호출 0.
...
계단 2. `probe.py` 실제 실행: PASS. `results\exp08_toc_feasibility\report.md` 갱신 출력 확인. LLM 호출 0.
