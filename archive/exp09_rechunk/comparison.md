...
입력 스냅샷: `archive/snapshots/semantic_run1`, `archive/snapshots/pagesplit_run1`. 평가 산출: `eval_semantic_run1.json`, `eval_pagesplit_run1.json`. ward K=10은 lancedb의 `entity_description` 벡터(1536-dim, L2 정규화)에 scipy ward linkage 적용.
